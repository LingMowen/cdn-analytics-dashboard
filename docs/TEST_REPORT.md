...
| 地理位置 | 显示地理位置 | 正确显示地理位置 | ✅ 通过 | ✅ |
| 错误处理 | 处理加载错误 | 正确显示错误信息 | ✅ 通过 | ✅ |
| 请求与性能板块 | 显示请求数、响应耗时 | 正确显示请求与性能数据 | ✅ 通过 | ✅ |
| 安全分析板块 | 显示安全拦截数据 | 正确显示安全分析数据 | ✅ 通过 | ✅ |
| 时间粒度选择 | 选择不同时间粒度 | 数据按时间粒度正确显示 | ✅ 通过 | ✅ |
| 环比数据显示 | 显示与上一周期对比 | 正确显示环比百分比 | ✅ 通过 | ✅ |
| TOP 分析板块 | 显示 TOP URL、浏览器等 | 正确显示 TOP 分析数据 | ✅ 通过 | ✅ |
