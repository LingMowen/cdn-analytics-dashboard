const countryNames = {
  ...
  'BT': '不丹', 'BO': '玻利维亚', 'BQ': '荷属博内尔', 'BA': '波黑', 'BW': '博茨瓦纳',
  'BV': '布维特岛', 'BR': '巴西', 'IO': '英属印度洋领地', 'VG': '英属维尔京群岛',
  'BN': '文莱', 'BG': '保加利亚', 'BF': '布基纳法索', 'BI': '布隆迪', 'CV': '佛得角',
  'KH': '柬埔寨', 'CM': '喀麦隆', 'CA': '加拿大', 'KY': '开曼群岛', 'CF': '中非共和国',
  'TD': '乍得', 'CL': '智利', 'CN': '中国', 'CX': '圣诞岛', 'CC': '科科斯群岛',
  'CO': '哥伦比亚', 'KM': '科摩罗', 'CG': '刚果共和国', 'CD': '刚果民主共和国',
  'CK': '库克群岛', 'CR': '哥斯达黎加', 'CI': '科特迪瓦', 'HR': '克罗地亚', 'CU': '古巴',
  'CW': '库拉索', 'CY': '塞浦路斯', 'CZ': '捷克', 'DK': '丹麦', 'DJ': '吉布提',
  'DM': '多米尼克', 'DO': '多米尼加共和国', 'EC': '厄瓜多尔', 'EG': '埃及', 'SV': '萨尔瓦多',
  'GQ': '赤道几内亚', 'ER': '厄立特里亚', 'EE': '爱沙尼亚', 'SZ': '斯威士兰', 'ET': '埃塞俄比亚',
  'FK': '福克兰群岛', 'FO': '法罗群岛', 'FJ': '斐济', 'FI': '芬兰', 'FR': '法国',
  'GF': '法属圭亚那', 'PF': '法属波利尼西亚', 'TF': '法属南部领地', 'GA': '加蓬',
  ...
  'LU': '卢森堡', 'MO': '澳门', 'MK': '北马其顿', 'MG': '马达加斯加', 'MW': '马拉维',
  ...
  'NR': '瑙鲁', 'NP': '尼泊尔', 'NL': '荷兰', 'NC': '新喀里多尼亚', 'NZ': '新西兰',
  'NI': '尼加拉瓜', 'NE': '尼日尔', 'NG': '尼日利亚', 'NU': '纽埃', 'NF': '诺福克岛',
  'MP': '北马里亚纳群岛', 'NO': '挪威', 'OM': '阿曼', 'PK': '巴基斯坦', 'PW': '帕劳',
  'PS': '巴勒斯坦', 'PA': '巴拿马', 'PG': '巴布亚新几内亚', 'PY': '巴拉圭', 'PE': '秘鲁',
  'PH': '菲律宾', 'PN': '皮特凯恩群岛', 'PL': '波兰', 'PT': '葡萄牙', 'PR': '波多黎各',
  'QA': '卡塔尔', 'RE': '留尼汪', 'RO': '罗马尼亚', 'RU': '俄罗斯', 'RW': '卢旺达',
  'BL': '圣巴泰勒米', 'SH': '圣赫勒拿', 'KN': '圣基茨和尼维斯', 'LC': '圣卢西亚',
  ...
  'GS': '南乔治亚和南桑威奇群岛', 'SS': '南苏丹', 'ES': '西班牙', 'LK': '斯里兰卡',
  'SD': '苏丹', 'SR': '苏里南', 'SJ': '斯瓦尔巴群岛和扬马延岛', 'SE': '瑞典', 'CH': '瑞士',
  ...
  'VU': '瓦努阿图', 'VA': '梵蒂冈', 'VE': '委内瑞拉', 'VN': '越南', 'WF': '瓦利斯和富图纳',
  'EH': '西撒哈拉', 'YE': '也门', 'ZM': '赞比亚', 'ZW': '津巴布韦',
  'Afghanistan': '阿富汗', 'Albania': '阿尔巴尼亚', 'Algeria': '阿尔及利亚',
  'Andorra': '安道尔', 'Angola': '安哥拉', 'Argentina': '阿根廷', 'Armenia': '亚美尼亚',
  ...
  'Burundi': '布隆迪', 'Cambodia': '柬埔寨', 'Cameroon': '喀麦隆', 'Canada': '加拿大',
  'Chad': '乍得', 'Chile': '智利', 'China': '中国', 'Colombia': '哥伦比亚',
  'Comoros': '科摩罗', 'Costa Rica': '哥斯达黎加', 'Croatia': '克罗地亚', 'Cuba': '古巴',
  'Cyprus': '塞浦路斯', 'Czech Republic': '捷克', 'Denmark': '丹麦', 'Djibouti': '吉布提',
  'Dominica': '多米尼加', 'Dominican Republic': '多米尼加共和国', 'Ecuador': '厄瓜多尔',
  ...
  'Jordan': '约旦', 'Kazakhstan': '哈萨克斯坦', 'Kenya': '肯尼亚', 'Kuwait': '科威特',
  ...
  'Maldives': '马尔代夫', 'Mali': '马里', 'Malta': '马耳他', 'Mauritania': '毛里塔尼亚',
  ...
  'North Macedonia': '北马其顿', 'Norway': '挪威', 'Oman': '阿曼', 'Pakistan': '巴基斯坦',
  ...
  'Saint Vincent and the Grenadines': '圣文森特和格林纳丁斯', 'San Marino': '圣马力诺',
  ...
  'South Africa': '南非', 'South Korea': '韩国', 'Spain': '西班牙', 'Sri Lanka': '斯里兰卡',
  ...
  'Uruguay': '乌拉圭', 'Uzbekistan': '乌兹别克斯坦', 'Vatican City': '梵蒂冈',
  'Venezuela': '委内瑞拉', 'Vietnam': '越南', 'Yemen': '也门', 'Zambia': '赞比亚',
  'Zimbabwe': '津巴布韦', 'Hong Kong': '香港', 'Macau': '澳门', 'Tibet': '西藏',
  'Inner Mongolia': '内蒙古', 'Guangxi': '广西', 'Ningxia': '宁夏', 'Xinjiang': '新疆',
};

export function getCountryName(name, language = 'zh') {
  if (!name) return '';
  if (language === 'zh') {
    ...
    if (countryNames[upperName]) {
      return countryNames[upperName];
    }
  }
  return name;
}
